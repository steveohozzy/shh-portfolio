...
const FloatingBadge = memo(function FloatingBadge({
  ...
  return (
    <div
      ...
      className={`absolute px-4 py-2 bg-card/80 backdrop-blur-sm border border-border rounded-full text-xs font-mono text-primary animate-float cursor-default transition-all duration-300 ${className} ${
        isHovered ? "scale-110 border-primary shadow-lg shadow-primary/20" : ""
      }`}
...
export function HeroSection() {
  ...
  const [, setIsShortHeight] = useState(false)

  // Dynamically computes total years from starting year 2006
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-1/4 -right-32 w-96 h-96 bg-primary/10 rounded-full blur-3xl animate-gradient opacity-30"
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-8">
            ...
            <div
              className={`flex items-center gap-6 pt-8 transition-all duration-700 delay-700 ${
                mounted
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-4"
              }`}
          ...
          <div className="relative hidden lg:flex items-center justify-center">
            <div className="relative w-80 h-80 xl:w-[420px] xl:h-[420px]">
              ...
              <div
                className="absolute inset-2 rounded-full border border-dashed border-primary/10 animate-spin-slow"
                style={{
      ...
      <div
        className={`absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-muted-foreground transition-all duration-1000 delay-1000 ${
          mounted
            ? "opacity-100 translate-y-0"
            : "opacity-0 translate-y-4"
        }`}
