...
const experience = [
  {
    ...
    description:
      "Working for Britain’s largest toy retailer, I lead and develop all front-end experiences across the website. This includes complete site redesigns, content hubs, new feature development, competitions, games, and more. I collaborate closely with our back-end agency to deliver the full customer-facing experience on The Entertainer website, and I play a key role in shaping technical direction, UI/UX decisions, testing approaches, and tooling. I work alongside our testing lead to design and deliver meaningful multi-variant experiments in Dynamic Yield, helping us understand user behaviour and continuously improve conversion and engagement. I also lead improvements across platform performance and partner integrations, including the implementation of new tools and services.",
  },
  {
